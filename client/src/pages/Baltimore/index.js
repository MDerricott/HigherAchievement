...
class Maryland extends Component {
  constructor() {
    super()
    this.state = {
      poverty: [],
      displayText: "hide",
      viewBox: "5950 -850 980 751",
      radius: 0,
      zoom: 23,
      circle: "visible",
      zoomedIn: false,
      ...
      test: "test",
      centers: [
        { markerOffset: 10,markerXOff:-55, name: "Lakeland", coordinates: [-76.6448, 39.2537], id: "5c3b7d308296f336bce86ccf" ,route: "Lakeland"},
        { markerOffset: 10,markerXOff:-60, name: "Commodore", coordinates: [-76.5880, 39.2933], id: "5c3b84538296f336bce86ee1",route: "Commodore"},
      ...
      <CustomCard style={{height: 150}}>
              <CardHeader color="warning" stats icon>
                ...
                <Typography 
                  ...
                  <small>  Balitmore City Public Schools</small>
                </Typography>
              </CardHeader>
              <CustomCardFooter stats>
              <Typography style={{
...
export default withStyles ({styles}) (Maryland);
