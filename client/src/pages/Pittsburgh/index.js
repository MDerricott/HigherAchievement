 ...
 extends Component {
  constructor() {
    ...
    this.state = {
      ...
      test: "test",
      centers: [
        { markerOffset: 10,markerXOff:-55, name: "West End", coordinates: [-80.0552, 40.4544], id: "5c3b7d308296f336bce86ccf" ,route: "West-End"},
        { markerOffset: 10,markerXOff:-60, name: "Homewood", coordinates: [-79.8899, 40.4586], id: "5c3b84538296f336bce86ee1",route: "Homewood"},
        // { markerOffset: 10,markerXOff:60, name: "Cherry Hill", coordinates: [-76.6238, 39.2480], id: "5c3b84668296f336bce86ee7", route:"Cherry-Hill"},
        ]
    }
  ...
  componentDidMount() {
      ...
      .then(res => {
        ...
        const penData = res.data
        this.setState({ poverty: penData })
      })
                      ...
                      <Paper  elevation={0}>
                        ...
                        <ZoomableGroup  zoom={this.state.zoom} >
                              <Geographies geography={map} disableOptimization>
                                ...
                                return (
                                    <Tooltip 
                                        title={`${statePoverty[0]} estimated in poverty ${this.useCommas(statePoverty[1])}`} placement="top" disableFocusListener key={i}> 
                                      <Geography
      ...
      <CustomCard style={{height: 150}}>
              <CardHeader color="warning" stats icon>
                ...
                <Typography 
                  ...
                  <small> Pittsburgh School District</small>
                </Typography>
              </CardHeader>
              <CustomCardFooter stats>
              <Typography style={{
...
export default withStyles ({styles}) (Pennsylvania
  );
